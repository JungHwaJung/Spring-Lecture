package com.product.spring.controller.member;
...
import com.product.spring.service.member.MemberService;
...
public class MemberController {
	...
	public ModelAndView logout(HttpSession session, ModelAndView mav) {
		memberService.logout(session);	//세션 초기화작업
